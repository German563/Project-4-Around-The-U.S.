...
export const  cardTemplate = document.querySelector("#card-template").content.querySelector(".card__gallery");
export const  placesList = document.querySelector(".card__area");
export const  bigImg = document.querySelector(".popup_type_foto");
export const  openEditButton = document.querySelector(".gallery__pencil");
export const  closeButtons = document.querySelectorAll('.popup__close');
export const  saveProfileModal = profileModal.querySelector(".popup__button");
...
export const  galleryLink = document.querySelector(".popup__input_type_card-link");
...
export const  imageInCard = document.querySelector("#myImage");
