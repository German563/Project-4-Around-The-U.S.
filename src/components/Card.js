...
export default class Card {
  constructor({ name, link, cardTemplate, handleCardClick, handleDeleteCard, handleLikeButton, _id, userId, likes}) {
    this._name = name;
    this._link = link;
...
isLiked() {
  return this._likes.some((person) => person._id === "eb9b4fc7dcf52812ff98973c")
}
